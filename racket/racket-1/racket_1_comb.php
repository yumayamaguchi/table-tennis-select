            ...
            <div class="tabs-3">
                ...
                <div>
                    ...
                    <div class="chart">
                        ...
                        $list = array($rubber['price'], $rubber['vibration']); 
                        print($list); 
                        $data = json_encode($list); 
                        var_dump($data); 
                        ?>
                        <!-- $labels = <<<EOT <script type="text/javascript>
                            const fore = {
                            label: " フォア", backgroundColor: "rgba(179,181,198,0.5)" , data: [${data}], }; </script>
                            EOT; -->
                        
                            <canvas id="myChart-1" data-score=<?php print($rubber['price'] . ',' . $rubber['spped']); ?>></canvas>
                    </div>
                </div>
            </div>
            <!-- 組み合わせここまで -->
